 ...
 */
final class Version20190122201443 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE get5stats_matches (matchid INT AUTO_INCREMENT NOT NULL, mapnumber SMALLINT NOT NULL, start_time DATETIME NOT NULL, end_time DATETIME DEFAULT \'NULL\', winner VARCHAR(16) NOT NULL COLLATE utf8mb4_unicode_ci, mapname VARCHAR(64) NOT NULL COLLATE utf8mb4_unicode_ci, team1score SMALLINT NOT NULL, team2score SMALLINT NOT NULL, PRIMARY KEY(matchid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE get5stats_players (matchid INT AUTO_INCREMENT NOT NULL, mapnumber SMALLINT NOT NULL, steamid64 VARCHAR(32) NOT NULL COLLATE utf8mb4_unicode_ci, team VARCHAR(16) NOT NULL COLLATE utf8mb4_unicode_ci, rounds_played SMALLINT NOT NULL, name VARCHAR(64) NOT NULL COLLATE utf8mb4_unicode_ci, kills SMALLINT NOT NULL, deaths SMALLINT NOT NULL, assists SMALLINT NOT NULL, flashbang_assists SMALLINT NOT NULL, teamkills SMALLINT NOT NULL, headshot_kills SMALLINT NOT NULL, damage SMALLINT NOT NULL, bomb_plants SMALLINT NOT NULL, bomb_defuses SMALLINT NOT NULL, v1 SMALLINT NOT NULL, v2 SMALLINT NOT NULL, v3 SMALLINT NOT NULL, v4 SMALLINT NOT NULL, v5 SMALLINT NOT NULL, k2 SMALLINT NOT NULL, k3 SMALLINT NOT NULL, k4 SMALLINT NOT NULL, k5 SMALLINT NOT NULL, firstkill_t SMALLINT NOT NULL, firstkill_ct SMALLINT NOT NULL, firstdeath_ct SMALLINT NOT NULL, PRIMARY KEY(matchid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
